...
const returnArrayFn = (num1, num2) => {
    const sampleArray = [num1, num2];
    const [number1, number2] = sampleArray;
    console.log("Example of destructured values in an array =>", `first value = ${number1},`, `second value = ${number2}`);
};
returnArrayFn(2, 8);
// Arrow function that returns destructured object values.
const returnObjectFn = (name, age) => {
